package com.xiekang.exercise.consistencyHash;
...
public class ConsistentHashLoadBalance {
     ...
     *
     * ceilingEntry()
     * 该方法用于返回与大于或等于给定键的最小键相关的键-值映射，如果没有这样的键，则返回null。
     *
     * @param key
     * @return 节点名称
     */
    ...
    public static void main(String[] args){
        ...
        String xiekang = consistentHash.selectNode("xiekang");
        System.out.println(xiekang);
